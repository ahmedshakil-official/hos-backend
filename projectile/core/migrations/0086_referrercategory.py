# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-06-20 11:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.ReferrerCategory')),
                ('entry_by', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='core_referrercategory_entry_by', to=settings.AUTH_USER_MODEL, verbose_name=b'entry by')),
                ...
                ('updated_by', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='core_referrercategory_updated_by', to=settings.AUTH_USER_MODEL, verbose_name=b'last updated by')),
            ],
            options={
                'verbose_name': 'Referrer Category',
                'verbose_name_plural': 'Referrer Categories',
            },
        ),
    ]
