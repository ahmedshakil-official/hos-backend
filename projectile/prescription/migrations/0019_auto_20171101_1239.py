...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('prescription', '0018_auto_20171030_1915'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='is_allergy',
            field=enumerify.fields.SelectIntegerField(choices=[(0, b'Active'), (1, b'Inactive'), (2, b'Draft'), (3, b'Completed'), (4, b'Approved Draft'), (5, b'Absent')], db_index=True, default=1),
        ),
        migrations.AlterField(
            model_name='diagnosis',
            name='is_curable',
