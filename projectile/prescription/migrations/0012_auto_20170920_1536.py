...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('prescription', '0011_diagnosis_remarks'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='is_allergy',
            field=enumerify.fields.SelectIntegerField(choices=[(0, b'Active'), (1, b'Inactive'), (2, b'Draft'), (3, b'Completed')], db_index=True, default=1),
        ),
        migrations.AlterField(
            model_name='diagnosis',
            name='is_curable',
