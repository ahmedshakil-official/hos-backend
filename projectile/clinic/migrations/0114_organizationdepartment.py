# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-08-03 12:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('clinic', '0113_subservicereport_person_organization_employee'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='clinic.OrganizationDepartment')),
                ('entry_by', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='clinic_organizationdepartment_entry_by', to=settings.AUTH_USER_MODEL, verbose_name=b'entry by')),
                ...
                ('updated_by', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='clinic_organizationdepartment_updated_by', to=settings.AUTH_USER_MODEL, verbose_name=b'last updated by')),
            ],
            options={
