# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-08-07 13:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('pharmacy', '0062_auto_20180806_0632'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clone', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='pharmacy.ProductCategory')),
                ('entry_by', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='pharmacy_productcategory_entry_by', to=settings.AUTH_USER_MODEL, verbose_name=b'entry by')),
                ...
                ('updated_by', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='pharmacy_productcategory_updated_by', to=settings.AUTH_USER_MODEL, verbose_name=b'last updated by')),
            ],
            options={
                'abstract': False,
            },
